...
export const ROLE_TEMPLATES = new Map([
  [OBSERVABILITY_PROJECT_SCOPE_OBSERVER_NAME, OBSERVABILITY_PROJECT_SCOPE_OBSERVER],
  [OBSERVABILITY_CLUSTER_SCOPE_OBSERVER_NAME, OBSERVABILITY_CLUSTER_SCOPE_OBSERVER],
  [OBSERVABILITY_INSTANCE_OBSERVER_NAME, OBSERVABILITY_INSTANCE_OBSERVER],
  [OBSERVABILITY_INSTANCE_ADMIN_NAME, OBSERVABILITY_INSTANCE_ADMIN],
  [OBSERVABILITY_INSTANCE_TROUBLESHOOTER_NAME, OBSERVABILITY_INSTANCE_TROUBLESHOOTER],
]);
